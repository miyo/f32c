...
-- Module  Version: 5.7
--C:\lscc\diamond\3.6_x64\ispfpga\bin\nt64\scuba.exe -w -n clkgen -lang vhdl -synth synplify -arch xo3c00f -type pll -fin 25 -fclkop 50 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 

-- Mon May 02 14:24:33 2016
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  9, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  10, CLKFB_DIV=>  2, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
